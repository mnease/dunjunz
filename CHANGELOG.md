...
- **Dungeon fills 16:9 (playable stretch)** — rooms are **26×13** with the **walkable interior stretched** across the widescreen (not brick padding around a 16×11 box). Doors stay on the outer rim; entities map proportionally.
