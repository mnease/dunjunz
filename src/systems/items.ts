...
export const ITEM_TEMPLATES: Record<string, ItemTemplate> = {
  ...
  dwarf_axe: {
    id: 'dwarf_axe',
    name: 'DWARF AXE',
    blurb: 'Deep forje steel. Beard-approved. [W]',
    kind: 'gear',
    slot: 'weapon',
    baseAtk: 5,
    look: 'greataxe',
  ...
  gem_ring: {
    id: 'gem_ring',
    name: 'GEM RING',
    blurb: 'Vault gem on a finger. +DEF. [R]',
    kind: 'gear',
    slot: 'ring',
    baseDef: 2,
    look: 'iron',
  ...
  mead_flask: {
    id: 'mead_flask',
    name: 'MEAD FLASK',
    blurb: 'Roarhimz courage juice. Heals 3. [U]',
    kind: 'consumable',
    usable: true,
    heal: 3,
    stackable: true,
  ...
  /** Queen of the Wood Elves final gift — one random mithril. */
  legendary_elven_box: {
  ...
  mithril_blade: {
    id: 'mithril_blade',
    name: 'MITHRIL BLADE',
    blurb: 'Elven steel. Light as a leaf, mean as a root. [W]',
    kind: 'gear',
    slot: 'weapon',
    baseAtk: 5,
    look: 'iron',
  ...
  mithril_bow: {
    id: 'mithril_bow',
    name: 'MITHRIL BOW',
    blurb: 'Silverwood limbs. Needs ARROWS. Space/Z looses. [W]',
    kind: 'gear',
    slot: 'weapon',
    baseAtk: 4,
    look: 'magic_bow',
  ...
  mithril_staff: {
    id: 'mithril_staff',
    name: 'MITHRIL STAFF',
    blurb: 'Moonlit crystal. Space/Z casts. [W]',
    kind: 'gear',
    slot: 'weapon',
    baseAtk: 4,
    look: 'staff',
  ...
  mithril_breastplate: {
    ...
    blurb: 'Leaf-mail chest. Medium, shiny, judgmental. [B]',
    kind: 'gear',
    slot: 'breastplate',
    baseDef: 5,
    look: 'fighter_plate',
    armorCategory: 'medium',
    classAffinity: ['fighter', 'ranger', 'paladin'],
  },
  mithril_greaves: {
    id: 'mithril_greaves',
    name: 'MITHRIL GREAVES',
    blurb: 'Shin guards of the quiet grove. [G]',
    kind: 'gear',
    slot: 'greaves',
    baseDef: 3,
    look: 'plate_greaves',
  ...
  mithril_amulet: {
    id: 'mithril_amulet',
    name: 'MITHRIL AMULET',
    blurb: 'Heals more when you potion. Soft moss energy. [N]',
    kind: 'gear',
    slot: 'amulet',
    baseDef: 1,
    potionHealBonus: 2,
  ...
  mithril_ring: {
    id: 'mithril_ring',
    name: 'MITHRIL RING',
    blurb: 'Feels lucky. Elves swear by it. [R]',
    kind: 'gear',
    slot: 'ring',
    baseDef: 1,
    look: 'luck',
