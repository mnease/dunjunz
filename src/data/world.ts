...
export const ROOMS: Record<string, RoomDef> = {
  ...
  woodz_glade: {
    ...
    entities: [
      { kind: 'tree', id: 'glade-redwood-1', x: 2, y: 2, scale: 5.5 },
      { kind: 'tree', id: 'glade-redwood-2', x: 13, y: 2, scale: 6.0 },
      { kind: 'tree', id: 'glade-redwood-3', x: 2, y: 8, scale: 5.2 },
      { kind: 'tree', id: 'glade-redwood-4', x: 13, y: 8, scale: 5.8 },
      {
        kind: 'sign',
      ...
      { kind: 'heart', id: 'glade-heart', x: 2, y: 8 },
    ],
  },
  ...
  woodz_arch: {
    ...
    entities: [
      { kind: 'tree', id: 'arch-redwood-1', x: 2, y: 2, scale: 5.5 },
      { kind: 'tree', id: 'arch-redwood-2', x: 13, y: 2, scale: 5.8 },
      {
        kind: 'sign',
        id: 'arch-sign',
        x: 8,
  ...
  elfwood_gate: {
    ...
    entities: [
      ...
      { kind: 'tree', id: 'gate-tree-1', x: 2, y: 2, scale: 5.0 },
      { kind: 'tree', id: 'gate-tree-2', x: 13, y: 8, scale: 5.2 },
    ],
  },
  ...
  elfwood_waters: {
    ...
    entities: [
      ...
      { kind: 'tree', id: 'waters-tree-1', x: 2, y: 8, scale: 5.0 },
      { kind: 'tree', id: 'waters-tree-2', x: 13, y: 8, scale: 5.2 },
  ...
  elfwood_court: {
    ...
    entities: [
      ...
      { kind: 'tree', id: 'court-tree-1', x: 2, y: 2, scale: 4.8 },
      { kind: 'tree', id: 'court-tree-2', x: 13, y: 2, scale: 5.2 },
      { kind: 'tree', id: 'court-tree-3', x: 2, y: 8, scale: 5.0 },
      { kind: 'tree', id: 'court-tree-4', x: 13, y: 8, scale: 5.5 },
    ],
  },
  ...
  elfwood_thicket: {
    ...
    entities: [
      ...
      { kind: 'tree', id: 'thicket-tree-1', x: 2, y: 2, scale: 5.0 },
      { kind: 'tree', id: 'thicket-tree-2', x: 13, y: 2, scale: 5.2 },
      { kind: 'tree', id: 'thicket-tree-3', x: 2, y: 8, scale: 5.0 },
      { kind: 'tree', id: 'thicket-tree-4', x: 13, y: 8, scale: 5.5 },
      {
        kind: 'chest',
        id: 'thicket-chest',
        x: 8,
