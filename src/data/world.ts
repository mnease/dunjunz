...
export const ROOMS: Record<string, RoomDef> = {
  ...
  woodz_glade: {
    ...
    entities: [
      // Sky-piercing redwoods (tops never visible) — keep center clear for statues
      { kind: 'tree', id: 'glade-redwood-1', x: 1, y: 1, scale: 9.0 },
      { kind: 'tree', id: 'glade-redwood-2', x: 14, y: 1, scale: 9.5 },
      { kind: 'tree', id: 'glade-redwood-3', x: 1, y: 9, scale: 8.5 },
      { kind: 'tree', id: 'glade-redwood-4', x: 14, y: 9, scale: 9.2 },
      { kind: 'tree', id: 'glade-redwood-5', x: 2, y: 3, scale: 7.5 },
      { kind: 'tree', id: 'glade-redwood-6', x: 13, y: 3, scale: 8.0 },
      { kind: 'tree', id: 'glade-redwood-7', x: 2, y: 7, scale: 7.8 },
      { kind: 'tree', id: 'glade-redwood-8', x: 13, y: 7, scale: 8.2 },
      { kind: 'tree', id: 'glade-redwood-9', x: 1, y: 5, scale: 8.8 },
      { kind: 'tree', id: 'glade-redwood-10', x: 14, y: 5, scale: 9.0 },
      { kind: 'tree', id: 'glade-redwood-11', x: 3, y: 1, scale: 7.2 },
      { kind: 'tree', id: 'glade-redwood-12', x: 12, y: 9, scale: 7.6 },
      {
        kind: 'sign',
      ...
      { kind: 'heart', id: 'glade-heart', x: 3, y: 8 },
    ],
  },
  ...
  woodz_arch: {
    ...
    entities: [
      ...
      { kind: 'tree', id: 'arch-redwood-2', x: 14, y: 1, scale: 9.8 },
      { kind: 'tree', id: 'arch-redwood-3', x: 1, y: 9, scale: 8.8 },
      { kind: 'tree', id: 'arch-redwood-4', x: 14, y: 9, scale: 9.2 },
      { kind: 'tree', id: 'arch-redwood-5', x: 2, y: 4, scale: 8.0 },
      { kind: 'tree', id: 'arch-redwood-6', x: 13, y: 4, scale: 8.4 },
      {
        kind: 'sign',
        id: 'arch-sign',
        x: 8,
  ...
  elfwood_gate: {
    ...
    tiles: [
      ...
      '#g....####....g#',
      '#g....#..#....g#',
      '#g....#..#......', // east open → waters; west solid (portal realm)
      '#g....#..#....g#',
      '#g....####....g#',
      '#g............g#',
      '#gg..........gg#',
    ...
    entities: [
      ...
      // 3× denser sky-redwoods (paths/portal clear)
      { kind: 'tree', id: 'gate-redwood-1', x: 1, y: 1, scale: 10.0 },
      { kind: 'tree', id: 'gate-redwood-2', x: 14, y: 1, scale: 10.5 },
      { kind: 'tree', id: 'gate-redwood-3', x: 1, y: 9, scale: 9.5 },
      { kind: 'tree', id: 'gate-redwood-4', x: 14, y: 9, scale: 10.0 },
      { kind: 'tree', id: 'gate-redwood-5', x: 2, y: 3, scale: 8.5 },
      { kind: 'tree', id: 'gate-redwood-6', x: 13, y: 3, scale: 9.0 },
      { kind: 'tree', id: 'gate-redwood-7', x: 2, y: 7, scale: 8.8 },
      { kind: 'tree', id: 'gate-redwood-8', x: 13, y: 7, scale: 9.2 },
      { kind: 'tree', id: 'gate-redwood-9', x: 1, y: 5, scale: 9.0 },
      { kind: 'tree', id: 'gate-redwood-10', x: 14, y: 5, scale: 9.4 },
      { kind: 'tree', id: 'gate-redwood-11', x: 3, y: 1, scale: 8.0 },
      { kind: 'tree', id: 'gate-redwood-12', x: 12, y: 9, scale: 8.4 },
    ],
  },
  ...
  elfwood_waters: {
    ...
    entities: [
      ...
      { kind: 'tree', id: 'waters-redwood-2', x: 14, y: 1, scale: 9.8 },
      { kind: 'tree', id: 'waters-redwood-3', x: 1, y: 9, scale: 10.0 },
      { kind: 'tree', id: 'waters-redwood-4', x: 14, y: 9, scale: 10.2 },
      { kind: 'tree', id: 'waters-redwood-5', x: 2, y: 8, scale: 8.5 },
      { kind: 'tree', id: 'waters-redwood-6', x: 13, y: 8, scale: 8.8 },
      { kind: 'tree', id: 'waters-redwood-7', x: 1, y: 4, scale: 9.0 },
      { kind: 'tree', id: 'waters-redwood-8', x: 14, y: 4, scale: 9.2 },
      { kind: 'tree', id: 'waters-redwood-9', x: 2, y: 6, scale: 8.2 },
      { kind: 'tree', id: 'waters-redwood-10', x: 13, y: 6, scale: 8.4 },
      { kind: 'tree', id: 'waters-redwood-11', x: 3, y: 9, scale: 7.8 },
      { kind: 'tree', id: 'waters-redwood-12', x: 12, y: 9, scale: 8.0 },
      { kind: 'heart', id: 'waters-heart', x: 12, y: 2 },
    ],
  },
  ...
  elfwood_court: {
    ...
    entities: [
      ...
      { kind: 'tree', id: 'court-redwood-2', x: 14, y: 1, scale: 10.5 },
      { kind: 'tree', id: 'court-redwood-3', x: 1, y: 9, scale: 9.5 },
      { kind: 'tree', id: 'court-redwood-4', x: 14, y: 9, scale: 10.0 },
      { kind: 'tree', id: 'court-redwood-5', x: 2, y: 3, scale: 8.5 },
      { kind: 'tree', id: 'court-redwood-6', x: 13, y: 3, scale: 9.0 },
      { kind: 'tree', id: 'court-redwood-7', x: 2, y: 7, scale: 8.8 },
      { kind: 'tree', id: 'court-redwood-8', x: 13, y: 7, scale: 9.2 },
      { kind: 'tree', id: 'court-redwood-9', x: 1, y: 5, scale: 9.0 },
      { kind: 'tree', id: 'court-redwood-10', x: 14, y: 5, scale: 9.4 },
      { kind: 'tree', id: 'court-redwood-11', x: 3, y: 1, scale: 8.2 },
      { kind: 'tree', id: 'court-redwood-12', x: 12, y: 9, scale: 8.6 },
    ],
  },
  ...
  elfwood_thicket: {
    ...
    entities: [
      ...
      { kind: 'tree', id: 'thicket-redwood-2', x: 14, y: 1, scale: 10.5 },
      { kind: 'tree', id: 'thicket-redwood-3', x: 1, y: 9, scale: 9.5 },
      { kind: 'tree', id: 'thicket-redwood-4', x: 14, y: 9, scale: 10.0 },
      { kind: 'tree', id: 'thicket-redwood-5', x: 2, y: 3, scale: 8.5 },
      { kind: 'tree', id: 'thicket-redwood-6', x: 13, y: 3, scale: 9.0 },
      { kind: 'tree', id: 'thicket-redwood-7', x: 2, y: 7, scale: 8.8 },
      { kind: 'tree', id: 'thicket-redwood-8', x: 13, y: 7, scale: 9.2 },
      { kind: 'tree', id: 'thicket-redwood-9', x: 1, y: 5, scale: 9.0 },
      { kind: 'tree', id: 'thicket-redwood-10', x: 14, y: 5, scale: 9.4 },
      { kind: 'tree', id: 'thicket-redwood-11', x: 3, y: 1, scale: 8.0 },
      { kind: 'tree', id: 'thicket-redwood-12', x: 12, y: 9, scale: 8.4 },
      {
        kind: 'chest',
        id: 'thicket-chest',
        x: 8,
